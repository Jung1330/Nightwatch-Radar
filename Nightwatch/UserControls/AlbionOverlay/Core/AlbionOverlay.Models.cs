...
{
    #region Enum ve Veri Sınıfları (Enums & Data Classes)
    ...
    public class RadarConfig
    {
        ...
        public bool EnableBetaHeatmap { get; set; } = false;

        public string LastMapIDConfig { get; set; }
        public int SelectedTheme { get; set; } = 1; // 0=Original, 1=Obsidian
        public string Language { get; set; } = "EN"; // Varsayılan dil Türkçe
        ...
        public bool[] ShowSoloEnchantments { get; set; } = new bool[] { true, true, true, true, true };
        public bool ShowSoloBossLair { get; set; } = true;
        public bool ShowGroupDungeons { get; set; } = true;
        public bool[] ShowGroupEnchantments { get; set; } = new bool[] { true, true, true, true, true };
        public bool ShowGroupBossLair { get; set; } = true;
        public bool ShowCorruptedDungeons { get; set; } = true;
        public bool ShowHellgateDungeons { get; set; } = true;
        ...
        public bool ShowBetaTracks { get; set; } = true;
        public bool ShowBetaWisps { get; set; } = true;
        public bool ShowBetaIndicators { get; set; } = true;
        public bool ShowBetaStructures { get; set; } = true;
        public bool ShowBetaChests { get; set; } = true;
        public bool ShowExits { get; set; } = true;
        public bool ShowWispCages { get; set; } = true;
        public bool ShowSmugglers { get; set; } = true;
        public bool ShowTrackers { get; set; } = true;
        public bool TrackBear { get; set; } = true;
        public bool TrackWolf { get; set; } = true;
        public bool TrackPanther { get; set; } = true;
        public bool TrackHumanoid { get; set; } = true;
        public bool TrackElemental { get; set; } = true;
        public bool TrackEnt { get; set; } = true;
        public bool TrackImp { get; set; } = true;
        public bool TrackGolem { get; set; } = true;
        public bool TrackWerewolf { get; set; } = true;
        public bool ShowAvalonianDungeons { get; set; } = true;
        public bool[] ShowAvalonianTiers { get; set; } = new bool[9] { true, true, true, true, true, true, true, true, true };
        public bool ShowNormalMobs { get; set; } = true;
        public bool ShowBosses { get; set; } = true;
        public bool ShowHiddenChests { get; set; } = true;

<h1 align="center">⚔️ Nightwatch - Albion Online Radar & Overlay</h1>

<p align="center">
  A modern, lightweight, and network-based radar overlay for Albion Online. <br>
  <i>Albion Online için modern, hafif ve ağ tabanlı radar uygulaması.</i>
</p>
...
- [ ] Zindan ve Sandık bildirimleri (Geliştirilecek)
...
### EN Features
**Nightwatch** is a high-performance helper tool that works by reading network packets without interfering with the game's memory (RAM).

* **🛡️ Advanced Player Tracking (ESP):** Nearby players' HP, True Average IP, and Full Equipment List.
...
- [ ] Dungeon and Chest notifications (Improvements)
- [ ] Stability fixes

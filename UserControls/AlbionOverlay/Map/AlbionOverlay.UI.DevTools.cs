        ...
        private void RenderDevToolsTab()
        {
                    if (ImGui.BeginTabBar("DevToolsTabs"))
                    {
                        ...
                        if (_developer == 1)
                        {
                            ...
                            {
                                ImGui.Spacing();
                                ImGui.TextColored(new Vector4(0.2f, 1f, 0.8f, 1), "Development & Debugging");
                                ImGui.Separator();

                            // TreeNode 1: Player Decode
                            if (ImGui.TreeNodeEx("Player Decode", ImGuiTreeNodeFlags.DefaultOpen))
                            {
                            ...
                            // TreeNode 2: Ports
                            if (ImGui.TreeNodeEx("Ports", ImGuiTreeNodeFlags.DefaultOpen))
                            {
                            ...
                            // TreeNode 3: Parser
                            if (ImGui.TreeNodeEx("Parser", ImGuiTreeNodeFlags.DefaultOpen))
                            {
                                ImGui.Spacing();
                                ...
                                {
                                    if (ImGui.BeginChild("ParserPlayers", new Vector2(420, 0), ImGuiChildFlags.Borders))
                                {

    ...
    public partial class AlbionOverlay
    {
        ...
        private void LoadConfig(string name)
        {
            ...
            try
            {
                ...
                _showSoloEnchantments = cfg.ShowSoloEnchantments ?? new bool[] { true, true, true, true, true };
                _showSoloBossLair = cfg.ShowSoloBossLair;
                _showGroupDungeons = cfg.ShowGroupDungeons;
                _showGroupEnchantments = cfg.ShowGroupEnchantments ?? new bool[] { true, true, true, true, true };
                ...
                _showAvalonianTiers = cfg.ShowAvalonianTiers ?? new bool[9] { true, true, true, true, true, true, true, true, true };
